...
public class Songs {
    ...
    public static final Map<Long, Song> SONGS = Stream.of(
            new Song(1, toMillis(2, 40), "Yesterday", "The Beatles"),
            new Song(2, toMillis(2, 59), "Paint It Black", "The Rolling Stones"),
            new Song(3, toMillis(5, 28), "Satisfaction", "The Rolling Stones"),
            new Song(4, toMillis(3, 51), "Dancing Queen", "Abba"),
            new Song(5, toMillis(3, 53), "Rolling in the Deep", "Adele"),
            new Song(6, toMillis(3, 11), "Another One Bites The Dust", "Queen"),
            new Song(7, toMillis(3, 54), "California Gurls", "Katy Perry"),
            new Song(8, toMillis(4, 57), "Time", "Hans Zimmer"),
